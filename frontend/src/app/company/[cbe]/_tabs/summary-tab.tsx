  ...
  return (
    <div className="space-y-6">
      ...
      {latest && (
        <div className="rounded-2xl border border-[#E2E8F2] bg-white overflow-hidden">
          ...
          <div className="px-5 pt-4 pb-3 flex items-baseline justify-between">
            <h3 className="text-[11px] font-bold text-[#8791A6] uppercase tracking-wider flex items-center gap-1.5">
          ...
          <div className="px-5 pb-5 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-9 gap-3">
            {/* Revenue */}
            <div className="rounded-xl border border-[#E2E8F2] bg-[#F7F9FC] px-3.5 py-3">
              <div className="flex items-center gap-1.5 text-[10.5px] font-semibold text-[#8791A6] uppercase tracking-wide mb-1.5">
                <DollarSign className="h-3 w-3" /> Revenue
              </div>
              <div className="text-[15px] font-bold text-[#08132B] font-mono">{fmtEur(latest.revenue)}</div>
            ...
            <div className="rounded-xl border border-[#E2E8F2] bg-[#F7F9FC] px-3.5 py-3">
              ...
              <div className="text-[15px] font-bold text-[#08132B] font-mono">{fmtEur(latest.ebitda)}</div>
            ...
            <div className="rounded-xl border border-[#E2E8F2] bg-[#F7F9FC] px-3.5 py-3">
              ...
              <div className="text-[15px] font-bold text-[#08132B] font-mono">{latest.fte_total != null ? fmtNumber(latest.fte_total) : "\u2014"}</div>
            ...
            <div className="rounded-xl border border-[#E2E8F2] bg-[#F7F9FC] px-3.5 py-3" title="Days Sales Outstanding = Trade Receivables / Revenue × 365. Higher = customers pay slower = cash-flow risk.">
              <div className="flex items-center gap-1.5 text-[10.5px] font-semibold text-[#8791A6] uppercase tracking-wide mb-1.5">
            ...
            <div className="rounded-xl border border-[#E2E8F2] bg-[#F7F9FC] px-3.5 py-3" title="Days Payable Outstanding = Trade Payables / Cost of Goods × 365. Higher = paying suppliers slower = better short-term cash position.">
              <div className="flex items-center gap-1.5 text-[10.5px] font-semibold text-[#8791A6] uppercase tracking-wide mb-1.5">
              ...
              <table className="w-full text-[11px] md:text-xs min-w-[600px]">
                <thead>
                  <tr className="border-t border-slate-50">
                    <th className="sticky left-0 z-[5] bg-white shadow-[1px_0_0_rgba(226,232,240,1)] px-5 py-2 text-left text-slate-400 font-medium w-[70px] md:w-auto">Year</th>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3">
        {/* Key People */}
        <div className="rounded-2xl border border-[#E2E8F2] bg-white p-4">
