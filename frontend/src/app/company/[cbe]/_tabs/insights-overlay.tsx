...
function InsightsDataSources({ insights }: { insights: AiInsights }) {
  ...
  if (insights.website_url) {
    chips.push({
      ...
      color: "bg-brand-soft text-[color:var(--brand-ink)] border-brand/30",
    });
  }
          ...
          <div className="p-6">
                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-600">
                          {insights.website_url && (
                            <span className="inline-flex items-center gap-1">
                              ...
                              <a href={insights.website_url.startsWith("http") ? insights.website_url : `https://${insights.website_url}`} target="_blank" rel="noopener noreferrer" className="text-brand hover:underline truncate max-w-[200px]">
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    {insights.website_url && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 text-xs text-brand hover:text-[color:var(--brand-ink)] transition-colors rounded-md border border-brand/20 bg-brand-soft/50 px-3 py-1.5"
                      >
            ...
            {!insights && !loading && !error && (
              <div className="py-8 text-center">
                <div className="mx-auto mb-4 h-12 w-12 rounded-full bg-brand-soft flex items-center justify-center">
                ...
                <button
                  onClick={onGenerate}
                  className="inline-flex items-center gap-2 rounded-lg bg-brand px-4 py-2 text-sm font-medium text-white hover:bg-[color:var(--brand-ink)] transition-colors"
                >
